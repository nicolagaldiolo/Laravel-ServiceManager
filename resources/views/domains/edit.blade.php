        ...
        <div class="m-portlet">
            ...
            <form class="m-form m-form--fit m-form--label-align-right" id="m_form_1">
                <div class="m-portlet__body">
                    ...
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-8 col-md-12">
                            <div class="m-input-icon m-input-icon--left">
                                <input type="text" class="form-control m-input" name="url" placeholder="Enter your url" value="{{old('url', $domain->url)}}">
                    ...
                    <div class="form-group m-form__group row">
                        <label class="col-form-label col-lg-3 col-sm-12">Dominio *</label>
                        <div class="col-lg-8 col-md-12">
                            <select class="form-control m-select2 m_select2_4 required" name="domain">
                                <option></option>
                                @foreach($providers as $provider)
                                    <option value="{{$provider->id}}">{{$provider->name}}</option>
                                @endforeach
                            </select>
                            <span class="m-form__help">Please select a domain providers.</span>
                        </div>
                    </div>
                    ...
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-8 col-md-12">
                            <select class="form-control m-select2 m_select2_4 required" name="hosting">
                                <option></option>
                                @foreach($providers as $provider)
                                    <option value="{{$provider->id}}">{{$provider->name}}</option>
                                @endforeach
                            </select>
                            <span class="m-form__help">Please select a hosting providers.</span>
                        </div>
                    </div>
                    ...
                    <div class="form-group m-form__group row">
                        <label class="col-form-label col-lg-3 col-sm-12">Scadenza *</label>
                        <div class="col-lg-8 col-md-12">
                            <div class="m-input-icon m-input-icon--left">
                                <input type="text" class="form-control required" id="m_datepicker_1" name="deadline" readonly placeholder="Select date" />
                                <span class="m-input-icon__icon m-input-icon__icon--left">
													<span>
                    ...
                    <div class="form-group m-form__group row">
                        <label class="col-form-label col-lg-3 col-sm-12">Importo *</label>
                        ...
                        <div class="col-lg-8 col-md-12">
                            <div>
																	<span class="m-switch m-switch--lg m-switch--icon m-switch--success">
																		<label>
																			<input type="checkbox" checked="checked" name="payed">
																			<span></span>
																		</label>
																	</span>
                            </div>
                    ...
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-8 col-md-12">
                            <textarea class="form-control m-input" name="note" placeholder="Enter a menu" rows="10">{{old('note', $domain->note)}}</textarea>
